...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *   운영체제나 프로그래밍 언어가 제공하는 기능을 제어 할 수 있도록 인터페이스를 뜻한다.
        ...
        * */
        ...
        /* 목차. 3. 원주율 */
        System.out.println("원주율 : " + Math.PI);    // PI 는 상수값으로 대문자 사용

        /* 목차. 4. 난수 출력 */
        System.out.println("랜덤 숫자 생성기 : " + Math.random()); // 0-1사이의 실수를 아무렇게나 출력해준다.
